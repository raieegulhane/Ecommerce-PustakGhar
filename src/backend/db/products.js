...
export const products = [
  ...
  },
  {
    ...
    inStock: false,
    bestSeller: false,
    description: "Emerging confidently from darkness and silence, she won over her blindness and deafness. Armed with curiosity and imagination, she was grateful for the senses and skills she possessed. Meet Helen Keller, whose life is a classic example of unfaltering determination.",
    coverImage: "https://images-na.ssl-images-amazon.com/images/I/711NKpSDfwS.jpg",
  },
  {
    _id: uuid(),
    ...
    inStock: true,
    bestSeller: false,
    description: "This unusual autobiography 'The Story of My Experiments with Truth', is a window to the workings of Mahatma Gandhi's mind- a window to the emotions of his heart, a window to understanding what drove this seemingly ordinary man to the heights of being the father of a nation- India",
    coverImage: "",
  },
  {
    _id: uuid(),
